...
| 7 | COŠTA DEL SOL | [costa-del-sol](https://github.com/ulebule/costa-del-sol) | the 1986 branching-road drivers (original game, no port) |
...
Deep links preselect a game: `#tower`, `#pinball`, `#batty`, `#boulder`, `#fist`, `#ruka`, `#costa` — for
